        ...
        <div class="rounded-1" style="background-color: #F5F5F5;">
            <table class="table text-center">
                ...
                <tr>
                    ...
                    <td><input readonly='true' value='{{ $ADVT->region }}' id='region_{{ $ADVT->id }}'></td>
                    <td><input readonly='true' value='{{ $ADVT->phone }}' id='phone_{{ $ADVT->id }}'></td>
                        ...
                        $(document).ready(function() {
                            ...
                            $('#btn_{{ $ADVT->id }}').click(function() {
                                if (!window.edit) {
                                    ...
                                    $('#phone_{{ $ADVT->id }}').prop('readonly', false);
                                    $('#region_{{ $ADVT->id }}').prop('readonly', false);
                                    ...
                                    cancelButton.click(function() {
                                        ...
                                        $('#phone_{{ $ADVT->id }}').prop('readonly', true).val('{{ $ADVT->phone }}');
                                        $('#region_{{ $ADVT->id }}').prop('readonly', true).val('{{ $ADVT->region }}');
